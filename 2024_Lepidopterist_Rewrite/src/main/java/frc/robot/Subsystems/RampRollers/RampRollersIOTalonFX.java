...
public class RampRollersIOTalonFX extends RampRollersIO {
    ...
    public void updateInputs() {
        BaseStatusSignal.refreshAll(rampRollersVelocityRad, rampRollersTemperature, 
            rampRollersAppliedVolts, rampRollersPosition, rampRollersStatorCurrent, rampRollersSupplyCurrent);

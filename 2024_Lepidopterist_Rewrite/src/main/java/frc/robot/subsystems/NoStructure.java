...
public class NoStructure {
  ...
  public NoStructure(RampRollers rampRollers, EndEffectorRollers endEffectorRollers, EndEffectorWrist endEffectorWrist){
  ...
  public enum WantedSuperState {
    ...
    STOPPED,
    ENDEFFECTOR_WRIST_PREPARED,
    ENDEFFECTOR_WRIST_HANDING_CORAL,

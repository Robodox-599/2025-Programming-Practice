...
public class ShooterRollerConstants {
  public static enum ShooterRollerStates {
    INTAKING(0),
    SCORING(1),      
    HOLDING(2),
    STOW(3);
  ...
  public static final double[] shooterRollerVelocities = {
    0.6, // intaking note
    -0.4, // scoring note
    0.0, // holding note
    0.0, // stowed
